...
public class StationsFragment extends Fragment implements StationsContract.MainView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mStationsPresenter = new StationsPresenter(this, new Fetcher());
    ...
    @Override
    public void setDataToRecyclerView(List<Station> stations) {
    ...
    @Override
    public void onFailureFetchedMessage(Throwable throwable) {
