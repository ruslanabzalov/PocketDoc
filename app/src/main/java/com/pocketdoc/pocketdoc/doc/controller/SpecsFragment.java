...
import com.pocketdoc.pocketdoc.doc.model.Spec;
...
public class SpecsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // TODO: Проверка наличия данных в базе данных.
    ...
    private void specsCall(DocDocApi api, int cityId) {
        Call<SpecsList> specialities = api.getSpecs(DocDocClient.AUTHORIZATION, cityId);
    ...
    private class SpecsHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private class SpecsAdapter extends RecyclerView.Adapter<SpecsHolder> {
        ...
        private SpecsAdapter(List<Spec> specialities) {
